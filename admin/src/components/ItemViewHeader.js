      ...
      <div className="searchbox" key="search">
        <form action={'/keystone/' + list.path} className="form-inline searchbox-form">
          ...
          <div className="searchbox-button">
            <button type="submit" className={submitButtonClass}>Buscar</button>
          </div>
          <button type="button" className="btn btn-link btn-cancel" onClick={this.toggleSearch.bind(this, false)}>Cancelar</button>
        </form>
      </div>
    );
  },
