...
var Form = React.createClass({
  ...
  render: function() {
    ...
    return (
      <div>
        <div className={modalClass} style={modalInlineStyle}>
          <div className="modal-dialog">
            <form className="modal-content" encType="multipart/form-data" method="post" action={formAction}>
              ...
              <div className="modal-header">
                ...
                <div className="modal-title">Criar {list.singular}</div>
              </div>
              ...
              <div className="modal-footer">
                <button type="submit" className="btn btn-create">Criar</button>
